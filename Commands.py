...
class CommandHandler:
    def __init__(self, pokemonDict: PokemonDict.PokemonDict, typeDict: TypeDict.TypeDict, NUMCOLUMNS):
    ...
    def ExecuteCommand(self, string: str) -> bool:
        if string == Enums.Commands.DRAFT.value:
            ...
            return DraftCommand.ExecuteDraftCommand(self.PokemonDict, self.TypeDict, self.NUMCOLUMNS)
